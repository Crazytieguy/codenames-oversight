...
param_str=nw-$nw-bnw-$bnw-bnnw-$bnnw-bf-$bf-aa-$aa
python -m codenames_oversight.evaluate_model --adversarial-alpha $aa $folder/cluer negligent-biased $nw $bnw $bnnw $bf < data/eval-games-6-4.jsonl > $results_folder/$param_str.jsonl
