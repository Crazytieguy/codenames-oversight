...
python -m codenames_debate.rloo --adversarial-alpha $adversarial_alpha data/ppo-small-dataset.jsonl models/llama-7b-random-cluer-small-r-256-merged models/rloo_negligent_biased/nw-$neglect_words-bnw-$bias_neglected_words-bnnw-$bias_non_neglected_words-bf-$bias_factor-aa-$adversarial_alpha negligent-biased $neglect_words $bias_neglected_words $bias_non_neglected_words $bias_factor
